...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: kYY4fYBHXGcm/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__c96HT)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___0VyF6)}
              role={"img"}
            />
          ),
